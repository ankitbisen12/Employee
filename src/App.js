...
import RoleModel from "./components/Card/Employee";
...
const App = () => {
  ...
  const fetchUserHandler = useCallback(async () => {
    ...
    try {
      const response = await fetch(
        "https://emp-app-478f5-default-rtdb.firebaseio.com//user.json"
      );
  ...
  let buttonContent = <span>See Employees</span>;
  if (isLoading) {
